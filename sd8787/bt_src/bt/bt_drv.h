...
typedef struct _BT_HCI_CAL_CMD
{
    /** OCF OGF */
    u16 ocf_ogf;
    /** Length */
    ...
    /** Data */
    u8 data[32];
} __ATTRIB_PACK__ BT_HCI_CAL_CMD;
...
/** Bluetooth command : Wirte Calibration data */
#define BT_CMD_WRITE_CAL_DATA		0x61
...
int bt_mac_to_u8(u8 * mac_addr, char *buf);
